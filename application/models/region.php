...
class Region extends Eloquent{
	...
	public function create_region($client_data){
		try{
...
$arr["description"] = $client_data->description;
	...
	public function update_region($client_data){
		try{
...
$arr["description"] = $client_data->description;
	...
	public function get_regions($client_data){
		try{
			$filter_array = array();
...
$filter_array["regions.description"] = "%".$client_data["description"]."%";
...
$query = DataHelper::filter_data($query,"regions.description",$filter_array,"string","like");
